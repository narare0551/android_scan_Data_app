...
import static com.example.ble_gatt_example.Common.Constants.SERVICE_STRING;
...
public class BluetoothUtils {
    ...
    public static BluetoothGattCharacteristic findCharacteristic(BluetoothGatt _gatt, String _uuid_string) {
        List<BluetoothGattService> service_list = _gatt.getServices();
        BluetoothGattService service = com.example.ble_gatt_example.Common.BluetoothUtils.findGattService(service_list);
        if (service == null) {
            return null;
        }
